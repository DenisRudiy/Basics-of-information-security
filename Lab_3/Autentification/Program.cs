...
namespace lab3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // повідомлення яке треба хешувати
            Console.Write("Enter message:  ");
            string message = Console.ReadLine();

            Console.WriteLine("");
            byte[] messageInArray = Encoding.Unicode.GetBytes(message);        // робимо повідомлення масивом
            ...
            Console.WriteLine($"HMAC SHA1:     {Convert.ToBase64String(HmacSHA1)}"); // конвертуємо у string
            ...
            Console.WriteLine($"HMAC SHA1 (second hashing):     {Convert.ToBase64String(Hmac2SHA1)}"); // конвертуємо у string
